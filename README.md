...
- **Admin Settings UI** — Configure all HackL4bs settings via the web UI (no env/compose edits needed)
...
All key HackL4bs settings can be changed at runtime via the **Admin Panel → ⚙️ Settings** tab:
