...
class Settings(BaseSettings):
    ...
    MAX_INSTANCES_PER_USER: int = 1  # 1 instancia activa por persona
    MAX_INSTANCES_PER_TEAM: int = 4  # 4 instancias activas por equipo
    ...
    # Anti-cheat settings
    AUTO_DELETE_CHEATS: bool = True  # Automáticamente eliminar envíos sospechosos de CTFd
    STOP_INSTANCE_ON_CHEAT: bool = True  # Detener la instancia del tramposo
    DISCORD_WEBHOOK_URL: Optional[str] = None  # Enviar alertas a Discord
    ...
    NETWORK_PREFIX: str = "hackl4bs"  # Prefix for instance networks
