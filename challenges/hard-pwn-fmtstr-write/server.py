...
<head>
<meta charset="utf-8">
<title>LogSys Corp &mdash; Sistema de Registro</title>
<style>
...
<body>
<h1>LogSys Corp &mdash; Sistema de Registro</h1>

<div class="box">
  <h2>Servicio activo</h2>
  <p>Un sistema de registro de eventos corre en el puerto <strong>9999</strong>.</p>
  <p>Introduce tu mensaje de log. Algo en el formateo no est&aacute; bien.</p>
</div>

<div class="box">
  <h2>Descargas</h2>
  <ul style="padding-left:20px;">
    <li><a href="/download/logger">logger &mdash; ELF 64-bit x86-64</a></li>
  </ul>
</div>
...
<div class="box">
  ...
  <table>
    ...
    <tr><td>RELRO</td>               <td class="off">Partial &mdash; GOT es escribible</td></tr>
  </table>
</div>

<div class="box">
  <p class="hint">El formato es poder &mdash; quien controla el formato, controla el flujo.</p>
</div>
</body>
</html>"""
