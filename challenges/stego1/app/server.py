...
<body>
  <div class="container">
    <h1>&#128247; La Flag Perdida</h1>
    <span class="tag">intermediate &bull; forensic</span>
    <p class="desc">
      Una imagen que esconde más de lo que muestra. El investigador dejó instrucciones,
      pero están dispersas. Sigue el rastro.
    </p>
    <div class="btn-group">
      <a href="/download/imagen" class="download-btn">&#11015; Download flag_perdida.png</a>
      <a href="/download/instrucciones" class="download-btn">&#11015; Download leer.txt</a>
    </div>
    <div class="info">
      <h3>Hint</h3>
      <p>Hay datos en la imagen que no forman parte de la imagen en sí. Búscalos y reconstruye lo que esconden.</p>
    </div>
  </div>
</body>
</html>"""
...
@app.route('/download/imagen')
def download_imagen():
    return send_file('/app/flag_perdida.png', as_attachment=True, download_name='flag_perdida.png')


@app.route('/download/instrucciones')
def download_instrucciones():
    return send_file('/app/leer.txt', as_attachment=True, download_name='leer.txt')
