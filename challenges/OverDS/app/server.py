...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .tag { display: inline-block; background: #1f6feb; color: white; font-size: 0.72rem; padding: 2px 8px;
border-radius: 3px; margin-bottom: 20px; text-transform: uppercase; }
    .desc { color: #8b949e; line-height: 1.7; margin-bottom: 28px; }
    .download-btn { display: inline-block; background: #238636; color: white; text-decoration: none; padding: 12px
28px; border-radius: 6px; font-size: 1rem; }
    .download-btn:hover { background: #2ea043; }
    .info { background: #161b22; border: 1px solid #30363d; border-radius: 6px; padding: 18px; margin-top: 28px;
...
<body>
  <div class="container">
    ...
    <p class="desc">
      ...
      Pero lo que contiene adentro podria sorprenderte.
    </p>
    <a href="/download" class="download-btn">&#11015; Download bajando_pepa.jpg</a>
    <div class="flag-form">
    ...
    <div class="info">
      <h3>Hint</h3>
      <p>Las imagenes pueden contener mas de lo que el ojo ve.</p>
    </div>
  </div>
  <script>
    function submitAnswer() {
      ...
      .catch(function(){ result.className='err'; result.style.display='block'; result.textContent='Error de conexion';
});
    }
