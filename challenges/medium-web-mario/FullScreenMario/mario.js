...
function FullScreenMario() {
  ...
  // With that all set, choose the starting map.
  window.gameon = true;
  if(window.CTF_SECRET && window.WorldSecret) {
    // Hidden CTF chamber, reached via the /Xampl3_CtF/ directory.
    mapfuncs["Secret"] = { 1: WorldSecret };
    setMap("Secret", 1);
  } else {
    setMap(1,1);
  }
