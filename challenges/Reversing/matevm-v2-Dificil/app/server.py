...
<body>
  <div class="container">
    <h1>&#129302; MateVM v2</h1>
    <span class="tag">hard &bull; reversing</span>
    <p class="desc">
      El desarrollador aprendió de sus errores. Esta vez no hay reversión byte a byte.
      El estado es continuo y los checkpoints comprueban consistencia global.
      Esta vez necesitarás más que paciencia.
    </p>
    <a href="/download" class="download-btn">&#11015; Download matevm2</a>
    <div class="info">
      <h3>Hint</h3>
      <p>El análisis dinámico revela restricciones. Los solucionadores de satisfacibilidad resuelven restricciones.</p>
    </div>
  </div>
</body>
</html>"""
...
@app.route('/download')
def download():
    return send_file('/app/matevm2', as_attachment=True, download_name='matevm2')
