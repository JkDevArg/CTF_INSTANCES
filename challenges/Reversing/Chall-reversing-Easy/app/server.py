...
<body>
  <div class="container">
    ...
    <p class="desc">
      El equipo de respuesta a incidentes detectó un binario proveniente de una dirección catalogada
      como maliciosa de una APT peruana. El análisis dinámico no revela nada.
      Necesitas ir más profundo.
    </p>
    <a href="/download" class="download-btn">&#11015; Download OverUma.exe</a>
    <div class="info">
      <h3>Hint</h3>
      <p>A veces los binarios hablan si sabes cómo escucharlos. Las cadenas de texto son el primer paso.</p>
    </div>
  </div>
</body>
</html>"""
...
@app.route('/download')
def download():
    return send_file('/app/OverUma.exe', as_attachment=True, download_name='OverUma.exe')
