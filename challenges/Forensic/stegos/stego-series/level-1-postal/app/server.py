...
<head>
  <meta charset="UTF-8">
  <title>Ecos Ocultos &mdash; Postal</title>
  <style>
...
<body>
  <div class="container">
    <h1>&#128247; Ecos Ocultos &mdash; Postal</h1>
    <span class="tag">easy &bull; forensic</span>
    <p class="desc">
      Una postal digital fue capturada. A simple vista no revela nada.<br>
      Pero las im&aacute;genes guardan m&aacute;s de lo que muestran.
    </p>
    <a href="/download" class="download-btn">&#11015; Descargar postal.png</a>
    <div class="info">
      <h3>Hint</h3>
      <ul style="padding-left:18px; line-height:2;">
        <li>No todo lo importante est&aacute; a la vista. Las herramientas de an&aacute;lisis de metadatos pueden revelar capas ocultas.</li>
      </ul>
    </div>
  </div>
</body>
...
@app.route('/download')
def download():
    return send_file('/app/dist/postal.png', as_attachment=True, download_name='postal.png')
