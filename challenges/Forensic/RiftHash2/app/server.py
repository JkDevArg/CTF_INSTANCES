...
<head>
  <meta charset="UTF-8">
  <title>RiftHash2 &mdash; Crackme</title>
  <style>
...
<body>
  <div class="container">
    <h1>&#128274; RiftHash2 &mdash; Crackme</h1>
    <span class="tag">hard &bull; forensic</span>
    <p class="desc">
      El algoritmo mejor&oacute;. La sal cambi&oacute;. El espacio de b&uacute;squeda es considerablemente mayor esta vez.<br>
    ...
    <div class="btn-row">
      <a href="/download/hash" class="download-btn">&#11015; Descargar rifthash2.hash</a>
      <a href="/download/algo" class="download-btn secondary">&#11015; Descargar rifthash2.py</a>
    </div>
    <div class="info">
      <h3>Hint</h3>
      <ul style="padding-left:18px; line-height:2;">
        <li>65535 iteraciones. Misma estructura, diferente sal. El espacio de b&uacute;squeda es tu enemigo esta vez.</li>
      </ul>
    </div>
  </div>
</body>
...
def download_hash():
    return send_file('/app/dist/rifthash2.hash', as_attachment=True, download_name='rifthash2.hash')


@app.route('/download/algo')
def download_algo():
    return send_file('/app/dist/rifthash2.py', as_attachment=True, download_name='rifthash2.py')
