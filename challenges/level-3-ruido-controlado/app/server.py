...
<head>
  <meta charset="UTF-8">
  <title>Ecos Ocultos &mdash; Ruido Controlado</title>
  <style>
...
<body>
  <div class="container">
    <h1>&#127774; Ecos Ocultos &mdash; Ruido Controlado</h1>
    <span class="tag">hard &bull; forensic</span>
    <p class="desc">
      La imagen parece ruido aleatorio. No lo es.<br>
      El orden importa m&aacute;s que el contenido. Y el contenido est&aacute; cifrado.
    </p>
    <div class="btn-row">
      <a href="/download/imagen" class="download-btn">&#11015; Descargar ruido.png</a>
      <a href="/download/nota" class="download-btn secondary">&#11015; Descargar nota.txt</a>
    </div>
    <div class="info">
      <h3>Hint</h3>
      <ul style="padding-left:18px; line-height:2;">
        <li>El caos tiene un orden. Ese orden nace de una palabra y las dimensiones de lo que miras.</li>
      </ul>
    </div>
  </div>
</body>
...
def download_imagen():
    return send_file('/app/dist/ruido.png', as_attachment=True, download_name='ruido.png')


@app.route('/download/nota')
def download_nota():
    return send_file('/app/dist/nota.txt', as_attachment=True, download_name='nota.txt')
