...
<head>
<meta charset="utf-8">
<title>SafeBox Corp &mdash; Secure Vault v3</title>
<style>
...
<body>
<h1>SafeBox Corp &mdash; Secure Vault v3</h1>

<div class="box">
  <h2>Servicio activo</h2>
  <p>Una c&aacute;mara acorazada protegida por PIE corre en el puerto <strong>9999</strong>.</p>
  <p>Las direcciones cambian en cada ejecuci&oacute;n. Pero no todos los bits son aleatorios.</p>
</div>

<div class="box">
  <h2>Descargas</h2>
  <ul style="padding-left:20px;">
    <li><a href="/download/safebox">safebox &mdash; ELF 64-bit x86-64 (PIE)</a></li>
  </ul>
</div>
...
<div class="box">
  ...
  <table>
    ...
    <tr><td>PIE</td>                 <td class="ok">Enabled &mdash; ASLR completo</td></tr>
    <tr><td>Stack Canary</td>        <td class="off">Disabled</td></tr>
    <tr><td>RELRO</td>               <td class="ok">Full</td></tr>
  </table>
</div>

<div class="box">
  <p class="hint">La alineaci&oacute;n de p&aacute;ginas es una verdad inmutable &mdash; los &uacute;ltimos 12 bits nunca mienten.</p>
</div>
</body>
</html>"""
