...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .tag { display: inline-block; background: #9a3412; color: white; font-size: 0.72rem; padding: 2px 8px; border-radius: 3px; margin-bottom: 20px; text-transform: uppercase; }
...
<body>
  <div class="container">
    ...
    <div class="story">
      <p>Un desarrollador implementó RSA para proteger un mensaje corto.</p>
      <p>Eligió un exponente pequeño porque era "más eficiente".</p>
      <p>El módulo es grande. El exponente, no tanto.</p>
    </div>
    <p class="desc">
      Los parámetros del cifrado están disponibles públicamente.
      Descarga el archivo y encuentra el mensaje original.
    </p>
    <a href="/download" class="download-btn">&#11015; Descargar rsa_data.txt</a>
    <div class="info">
      <h3>Pista</h3>
      <ul style="padding-left:18px; line-height:2;">
        <li>A veces el módulo es tan grande que la aritmética modular no llega a aplicarse.</li>
      </ul>
    </div>
  </div>
</body>
...
@app.route('/download')
def download():
    return send_file('/app/dist/rsa_data.txt', as_attachment=True, download_name='rsa_data.txt')
