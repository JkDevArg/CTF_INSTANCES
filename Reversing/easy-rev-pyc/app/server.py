...
<body>
  <div class="container">
    <h1>&#128200; Byte by Byte</h1>
    <span class="tag">easy &bull; reversing</span>
    <p class="desc">
      A developer wrote a flag checker in Python and thought distributing only the compiled
      <code>.pyc</code> bytecode was enough to protect their logic. Download it and prove them wrong.
    </p>
    <a href="/download" class="download-btn">&#11015; Download challenge.pyc</a>
    <div class="info">
      <h3>Hints</h3>
      <ul style="padding-left:18px; line-height:2;">
        <li>Run it: <code>python3 challenge.pyc &lt;flag&gt;</code></li>
        <li>Decompile: <code>pycdc challenge.pyc</code> or <code>uncompyle6 challenge.pyc</code></li>
        <li>Bytecode analysis: <code>python3 -c "import dis, marshal, struct; ..."</code></li>
        <li>Compiled with Python 3.11 — use a compatible decompiler</li>
      </ul>
    </div>
  </div>
</body>
...
@app.route('/download')
def download():
    return send_file('/app/dist/challenge.pyc', as_attachment=True, download_name='challenge.pyc')
